...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-4">
            <div class="card p-2 pt-4">
                <div class="row justify-content-center">
                    <img class="card-img-top" src="image/ruler1.jpg" alt="dictionary">
                </div>
                <div class="row">
                    <div class="card-body">
        ...
        <div class="col-4">
            <div class="card p-2 pt-4">
                <div class="row justify-content-center" >
                    <img class="card-img-top" src="image/ruler2.jpg" alt="book">
                </div>
                <div class="row">
                    <div class="card-body">
                        <h4 class="card-title display-5">Item 1</h4>
        ...
        <div class="col-4">
            <div class="card p-2 pt-4">
                <div class="row justify-content-center">
                    <img class="card-img-top" src="image/ruler3.jpg" alt="ruler">
                </div>
                <div class="row">
                    <div class="card-body">
                        <h4 class="card-title display-5">Item 1</h4>
